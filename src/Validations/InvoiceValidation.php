<?php
namespace ChadPeng\ECPay\Validations;

use Illuminate\Support\Facades\Validator;
use ChadPeng\ECPay\Constants\ECPayCarruerType;
use ChadPeng\ECPay\Constants\ECPayClearanceMark;
use ChadPeng\ECPay\Constants\ECPayDonation;
use ChadPeng\ECPay\Constants\ECPayInvType;
use ChadPeng\ECPay\Constants\ECPayPrintMark;
use ChadPeng\ECPay\Constants\ECPayTaxType;
